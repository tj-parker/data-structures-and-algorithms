...
const addValues = (arr) => {
  // Solution code here...
  let sum = arr.reduce( (acc,value,i) => {
    acc = acc + value;
    return acc;
  }, 0);
  return sum;
...
const addPurchases = (arr) => {
  // Solution code here...
  let total = arr.reduce( (acc,value,i) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let count = arr.reduce( (acc,value,i) => {
    acc = (i + 1);
    return acc;
  }, 0);
  return count;
...
const returnNames = (arr) => {
  // Solution code here...
  let names = arr.reduce( (acc,value,i) => {
    acc.push(value.name);
    return acc;
  }, []);
  return names;
...
const reversedString = (str) => {
  // Solution code here...
  let arr = str.split('');
  let reverse = arr.reduce( (acc,value,i) => {
    return value + acc;
  }, '');
  return reverse;
};
